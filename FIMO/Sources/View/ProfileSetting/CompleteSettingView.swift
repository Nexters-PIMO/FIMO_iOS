    ...
    var body: some View {
        WithViewStore(self.store, observe: { $0 }) { viewStore in
            VStack(alignment: .leading) {
                ...
                Group {
                    paragraph(
                        image: Image(uiImage: FIMOAsset.Assets.completeLock.image),
                        title: "프라이빗 아카이브 기능",
                        body: "링크 없이 접근 불가\n개인별 아카이빙 유형 선택"
                    )
                    ...
                    paragraph(
                        image: Image(uiImage: FIMOAsset.Assets.completeOCR.image),
                    ...
                    paragraph(
                        image: Image(uiImage: FIMOAsset.Assets.completeSTT.image),
                        title: "텍스트 오디오 재생 기능",
                ...
                .background(Color(FIMOAsset.Assets.red1.color))
                .cornerRadius(2)
                .padding(.bottom, 60)
