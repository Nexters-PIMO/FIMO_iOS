...
enum OnboardingPageType: String {
    ...
    var backgroundImage: Image {
        switch self {
        case .one:
            return Image(uiImage: FIMOAsset.Assets.onboardingBackgroundOne.image)
        case .two:
            return Image(uiImage: FIMOAsset.Assets.onboardingBackgroundTwo.image)
        case .three:
            return Image(uiImage: FIMOAsset.Assets.onboardingBackgroundThree.image)
        case .four:
